                ...
                t.fn.selectScroll = function (i) {
                    ...
                    var n = e.call(this, this.settings.maxLevel),
                        r =
                            ...
                            this.settings.cancelTxt +
                            '</span>\n                    <span class="confirm">' +
                            this.settings.confirmTxt +
                    ...
                    (h.$wheel = []),
                        ...
                        (h.setSelectedIndex = function (t) {
                            h.bindSelectedIndex(t);alert(999);
                        }),
                        (h.updateSelectedIndex = function () {
                            ...
                            h.attr("data-selectindex") && (h.settings.selectedIndex = h.attr("data-selectindex").split(",").addClass('sss'));
                        }),
                        (h.bindSelectedIndex = function () {
                            for (var t = [], i = 0; i < h.$wheel.length; i++) t.push(h.$wheel[i].getSelectedIndex());
                            t.lenght && h.attr("data-selectIndex", t).addClass('sss');
                        }),
                        (h.detachButtonEvents = function () {
                            h.$confirm.unbind(), h.$cancel.unbind();
                        }),
                        (h.attachButtonEvents = function () {
                            (h.$confirm = h.$picker.find(".confirm").addClass(h.settings.confirmClass)),
                                h.$confirm.bind("click", { callback: h.settings.confirm }, h.confirm),
                                (h.$cancel = h.$picker.find(".cancel").addClass(h.settings.cancelClass)),
                                h.$cancel.bind("click", { callback: h.settings.cancel }, h.cancel);
                        }),
                        ...
                        (h._createWheel = function (t) {
                            ...
                            (h.$wheel[t] = new o.default(i[t], { wheel: { selectedIndex: h.settings.selectedIndex[t], wheelWrapperClass: "wheel-scroll", wheelItemClass: "wheel-item" }, probeType: 3 })),
                                t === h.settings.maxLevel - 1 && (h.show(), h.attachButtonEvents());
                        }),
                        (h._createHtml = function (i) {
                            for (var e = "", s = this.settings.data.length ? this.settings.data[i].length : 0, o = 0; o < s; o++)
                                e += '<li class="wheel-item" data-id="' + this.settings.data[i][o].id + '">' + this.settings.data[i][o].text + "</li>";
    ...
    function (t, i, e) {
        ...
        function w(t, i, e, s, o, n, r) {
            var h = t - i,
                ...
                g = t + (a / l) * (h < 0 ? -1 : 1);
            return (
                d && c && (g = Math.round(g / c) * c),
                g < s ? ((g = n ? Math.max(s - n / 4, s - (n / f) * a) : s), (m = p)) : g > o && ((g = n ? Math.min(o + n / 4, o + (n / f) * a) : o), (m = p)),
                { destination: Math.round(g), duration: m }
            );
        }
        function S() {}
        function b(t) {}
        ...
        function _(t) {
            ...
            return (
                ...
                "horizontal" === t
                    ? ((i.style.cssText += ";height:7px;left:2px;right:2px;bottom:0"), (e.style.height = "100%"), (i.className = "bscroll-horizontal-scrollbar"))
                    : ((i.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px"), (e.style.width = "100%"), (i.className = "bscroll-vertical-scrollbar")),
        ...
        (Y.prototype.handleEvent = function (t) {
            ...
            (Y.prototype._shouldShow = function () {
                return ("vertical" === this.direction && this.scroller.hasVerticalScroll) || ("horizontal" === this.direction && this.scroller.hasHorizontalScroll)
                    ? ((this.wrapper.style.display = ""), !0)
                    : ((this.wrapper.style.display = "none"), !1);alert(1);
            }),
            (Y.prototype._calculate = function () {
                if ("vertical" === this.direction) {
                    ...
                    (this.indicatorHeight = Math.max(Math.round((t * t) / (this.scroller.scrollerHeight || t || 1)), 8)),
                        ...
                        (this.sizeRatioY = this.maxPosY / this.scroller.maxScrollY);alert(1);
                } else {
                    ...
                    (this.indicatorWidth = Math.max(Math.round((i * i) / (this.scroller.scrollerWidth || i || 1)), 8)),
                        ...
                        (this.sizeRatioX = this.maxPosX / this.scroller.maxScrollX);alert(1);
                }
            }),
        ...
        (M.prototype.onScroll = function () {
                        ...
                        this.options.fetch(i).then(function (i) {
                            if (i) t.addContent(i);
                                ...
                                var e = t._removeTombstones(),
                                    s = 0;
                                t.anchorItem.index <= t.items.length
                                    ? ((s = t._fixScrollPosition()), t._setupAnimations({}, s), t.scroller.resetPosition(t.scroller.options.bounceTime))
                                    : ((t.anchorItem.index -= e), (s = t._fixScrollPosition()), t._setupAnimations({}, s), t.scroller.stop(), t.scroller.resetPosition(), t.onScroll());
                            }
                        }));
                }
            }),
            (M.prototype.addContent = function (t) {
                ...
                this.attachContent(), this.maybeRequestContent();alert(1);
            }),
            (M.prototype.attachContent = function () {
                ...
                this._setupAnimations(i, e);alert(1);
            }),
            ...
            (M.prototype._setupAnimations = function (t, i) {
                ...
                for (var s in t) {
                    var o = t[s];
                    (this.items[s].node.style.transform = "translateY(" + (this.anchorScrollTop + o[1]) + "px) scale(" + this.tombstoneWidth / this.items[s].width + ", " + this.tombstoneHeight / this.items[s].height + ")"),
                        this.items[s].node.offsetTop,
                        o[0].offsetTop,
                        (this.items[s].node.style.transition = "transform 200ms");
                }
                for (var n = this.firstAttachedItem; n < this.lastAttachedItem; n++) {
                    var r = t[n];
                    if (r) {
                        var h = r[0];
                        (h.style.transition = "transform 200ms, opacity 200ms"),
                            (h.style.transform = "translateY(" + i + "px) scale(" + this.items[n].width / this.tombstoneWidth + ", " + this.items[n].height / this.tombstoneHeight + ")"),
                            (h.style.opacity = 0);
                    }
                    i !== this.items[n].top && (r || (this.items[n].node.style.transition = ""), (this.items[n].node.style.transform = "translateY(" + i + "px)")),
                        (this.items[n].top = i),
            ...
            (function (t) {
                (t.prototype._init = function (t, i) {
                    ...
                    (t.prototype._handleOptions = function (t) {
                        (this.options = o({}, $, t)),
                            (this.translateZ = this.options.HWCompositing && A ? " translateZ(0)" : ""),
                            (this.options.useTransition = this.options.useTransition && F),
                    ...
                    (t.prototype._handleDOMEvents = function (t) {
                        ...
                        t(window, "orientationchange", this),
                            ...
                            L && !this.options.disableTouch && (t(this.wrapper, "touchstart", this), t(i, "touchmove", this), t(i, "touchcancel", this), t(i, "touchend", this)),
                            t(this.scroller, N.transitionEnd, this);
                    }),
                        ...
                        s
                            ...
                            : ((this.maxScrollX = this.wrapperWidth - this.scrollerWidth),
                              ...
                              this.maxScrollX < 0
                                  ...
                                  : this.scale > 1 && ((this.maxScrollX = this.maxScrollX / 2 - this.relativeX), (this.minScrollX = this.maxScrollX)),
                              this.maxScrollY < 0
                                  ? ((this.maxScrollY -= this.relativeY), (this.minScrollY = -this.relativeY))
                                  : this.scale > 1 && ((this.maxScrollY = this.maxScrollY / 2 - this.relativeY), (this.minScrollY = this.maxScrollY))),
            ...
            (function (t) {
                (t.prototype._start = function (t) {
                    ...
                    if ((i === U || 0 === t.button) && !(!this.enabled || this.destroyed || (this.initiated && this.initiated !== i))) {
                        (this.initiated = i),
                            this.options.preventDefault && !u(t.target, this.options.preventDefaultException) && t.preventDefault(),
                            ...
                            if (!(h - this.endTime > this.options.momentumLimitTime && r < this.options.momentumLimitDistance && n < this.options.momentumLimitDistance)) {
                                if (
                                    (this.directionLocked ||
                                        ...
                                        (n > r + this.options.directionLockThreshold ? (this.directionLocked = "h") : r >= n + this.options.directionLockThreshold ? (this.directionLocked = "v") : (this.directionLocked = "n")),
                                ...
                                !1 !== m && ((c = void 0 === m.top || m.top), (p = void 0 === m.bottom || m.bottom), (d = void 0 === m.left || m.left), (u = void 0 === m.right || m.right)),
                                    (a > this.minScrollX || a < this.maxScrollX) && (a = (a > this.minScrollX && d) || (a < this.maxScrollX && u) ? this.x + e / 3 : a > this.minScrollX ? this.minScrollX : this.maxScrollX),
                                    (l > this.minScrollY || l < this.maxScrollY) && (l = (l > this.minScrollY && c) || (l < this.maxScrollY && p) ? this.y + o / 3 : l > this.minScrollY ? this.minScrollY : this.maxScrollY),
                                    this.moved || ((this.moved = !0), this.trigger("scrollStart")),
                                    this._translate(a, l),
                                    h - this.startTime > this.options.momentumLimitTime &&
                                        ((this.startTime = h), (this.startX = this.x), (this.startY = this.y), this.options.probeType === K && this.trigger("scroll", { x: this.x, y: this.y })),
                                    this.options.probeType > K && this.trigger("scroll", { x: this.x, y: this.y });
                                ...
                                (v > document.documentElement.clientWidth - this.options.momentumLimitDistance ||
                                    ...
                                    y < this.options.momentumLimitDistance ||
                                    y > document.documentElement.clientHeight - this.options.momentumLimitDistance) &&
                                    this._end(t);
                            }
                        }
                    }),
                            ...
                            if (((this.directionX = o > 0 ? J : o < 0 ? Q : 0), (this.directionY = n > 0 ? G : n < 0 ? Z : 0), !this.options.pullDownRefresh || !this._checkPullDown())) {
                                ...
                                if (!this.resetPosition(this.options.bounceTime, q.bounce)) {
                                    ...
                                    if (this.options.snap) {
                                        ...
                                        (this.currentPage = b),
                                            (l = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(i - b.x), 1e3), Math.min(Math.abs(e - b.y), 1e3)), 300)),
                                            (i = b.x),
                                            (e = b.y),
                                            (this.directionX = 0),
                                            (this.directionY = 0),
                                            (S = this.options.snap.easing || q.bounce);
                                    }
                    ...
                    (t.prototype._transitionEnd = function (t) {
                        t.target === this.scroller &&
                            this.isInTransition &&
                            (this._transitionTime(),
                            (!this.pulling || this.movingDirectionY === Z) &&
                                !this.resetPosition(this.options.bounceTime, q.bounce) &&
                                ((this.isInTransition = !1), this.options.probeType !== tt && this.trigger("scrollEnd", { x: this.x, y: this.y })));
                    }),
                    (t.prototype._translate = function (t, i, e) {
                        if (
                            (T(!n(t) && !n(i), "Translate x or y is null or undefined."),
                            n(e) && (e = this.scale),
                            this.options.useTransform
                                ? (this.scrollerStyle[N.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ)
                        ...
                        (this.isInTransition = this.options.useTransition && e > 0 && (t !== this.x || i !== this.y)),
                            !e || this.options.useTransition
                                ? (this._transitionTimingFunction(s.style),
                                  ...
                                  this._translate(t, i),
                                  e && this.options.probeType === tt && this._startProbe(),
                                  e ||
                                      (t === this.x && i === this.y) ||
                                      (this.trigger("scroll", { x: t, y: i }), (this._reflow = document.body.offsetHeight), this.resetPosition(this.options.bounceTime, q.bounce) || this.trigger("scrollEnd", { x: t, y: i })),
                                  this.options.wheel &&
                                      (i > this.minScrollY ? (this.selectedIndex = 0) : i < this.maxScrollY ? (this.selectedIndex = this.items.length - 1) : (this.selectedIndex = Math.round(Math.abs(i / this.itemHeight)))))
                    ...
                    (t.prototype.getComputedPosition = function () {
                        var t = window.getComputedStyle(this.scroller, null),
                            ...
                            e = void 0;
                        return (
                            this.options.useTransform ? ((t = t[N.transform].split(")")[0].split(", ")), (i = +(t[12] || t[4])), (e = +(t[13] || t[5]))) : ((i = +t.left.replace(/[^-\d.]/g, "")), (e = +t.top.replace(/[^-\d.]/g, ""))),
                            { x: i, y: e }
                        );
                    }),
                ...
                (t.prototype._initSnap = function () {
                            ...
                            if (((t.pages = []), t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight)) {
                                ...
                                if (s)
                                    for (c = s.length, u = -1; l < c; l++)
                                        (m = d(s[l])),
                                            (0 === l || m.left <= d(s[l - 1]).left) && ((p = 0), u++),
                                            t.pages[p] || (t.pages[p] = []),
                                            (n = Math.max(-m.left, t.maxScrollX)),
                                            (r = Math.max(-m.top, t.maxScrollY)),
                                            (h = n - Math.round(m.width / 2)),
                                            (a = r - Math.round(m.height / 2)),
                                            (t.pages[p][u] = { x: n, y: r, width: m.width, height: m.height, cx: h, cy: a }),
                                            n > t.maxScrollX && p++;
                                else
                                ...
                                var v = i.threshold;
                                v % 1 == 0
                                    ? ((t.snapThresholdX = v), (t.snapThresholdY = v))
                                    : ((t.snapThresholdX = Math.round(t.pages[t.currentPage.pageX][t.currentPage.pageY].width * v)), (t.snapThresholdY = Math.round(t.pages[t.currentPage.pageX][t.currentPage.pageY].height * v)));
                            }
                        }),
                        this.on("scrollEnd", function () {
                            i.loop &&
                                (i._loopX
                                    ? (0 === t.currentPage.pageX && t._goToPage(t.pages.length - 2, t.currentPage.pageY, 0), t.currentPage.pageX === t.pages.length - 1 && t._goToPage(1, t.currentPage.pageY, 0))
                                    : (0 === t.currentPage.pageY && t._goToPage(t.currentPage.pageX, t.pages[0].length - 2, 0), t.currentPage.pageY === t.pages[0].length - 1 && t._goToPage(t.currentPage.pageX, 1, 0)));
                        }),
                        !1 !== i.listenFlick &&
                    ...
                    (t.prototype._checkSnapLoop = function () {
                        ...
                        t.loop &&
                            this.pages &&
                            this.pages.length &&
                            (this.pages.length > 1 && (t._loopX = !0), this.pages[0] && this.pages[0].length > 1 && (t._loopY = !0), t._loopX && t._loopY && b("Loop does not support two direction at the same time."));
                    }),
                    (t.prototype._nearestSnap = function (t, i) {
                        ...
                        return (
                            e === this.currentPage.pageX && ((e += this.directionX), e < 0 ? (e = 0) : e >= this.pages.length && (e = this.pages.length - 1), (t = this.pages[e][0].x)),
                    ...
                    (t.prototype._goToPage = function (t) {
                        ...
                        if (o && this.pages && this.pages.length && ((s = s || o.easing || q.bounce), t >= this.pages.length ? (t = this.pages.length - 1) : t < 0 && (t = 0), this.pages[t])) {
                            ...
                            var n = this.pages[t][i].x,
                                r = this.pages[t][i].y;
                            (e = void 0 === e ? o.speed || Math.max(Math.max(Math.min(Math.abs(n - this.x), 1e3), Math.min(Math.abs(r - this.y), 1e3)), 300) : e),
