...
(function (global, factory) {
  ...
  var TEMPLATE = '<div class="picker" data-picker-action="hide" touch-action="none" tabindex="-1" role="dialog">' + 
                  ...
                  '</div>' + '<div class="picker-footer">' + 
                  '<button type="button" class="picker-cancel" data-picker-action="hide">초기화</button>' + 
                  '</div>' + 
                  '</div>' + 
                  '</div>';
