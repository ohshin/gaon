        ...
        e(2),
            (function (t) {
                t.fn.selectScroll = function (i) {
                    ...
                    var s = { title: "년월 선택", data: [], cancelTxt: "취소", cancelClass: "", confirmTxt: "적용", confirmClass: "", cancel: null, confirm: null, selectedIndex: [0, 0, 0], class: "" };
                    ...
                    var n = e.call(this, this.settings.maxLevel),
                        r =
                            ...
                            n +
                            '</div>\n                </div>\n                <div class="pop-footer-btn"><button class="btn-reset">초기화</button></div>\n            </div>\n        </div>',
                        h = this;
                    (h.$wheel = []),
                        (h.isEmpty = function () {
